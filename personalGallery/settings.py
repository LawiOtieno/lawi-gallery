...
SECRET_KEY = 'django-insecure-=g4t_5bx%cnjus9twf_cz%-h3c$^!e(a(4vjb-fn)(%ru0h897'
...
if config('MODE')=="dev":
   DATABASES = {
       'default': {
           ...
           'NAME': config('personalgalleries'),
           'USER': config('access'),
           'PASSWORD': config('lawioti'),
...
#         'NAME': 'personalgalleries',
#         'USER': 'access',
#         'PASSWORD':'lawioti',
#         # 'HOST':'localhost' Lawi1243
#     }
# }
